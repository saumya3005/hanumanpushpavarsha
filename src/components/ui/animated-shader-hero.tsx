...
const useShaderBackground = () => {
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      const activeDpr = Math.max(1, 0.5 * window.devicePixelRatio);
      activeCanvas.width = window.innerWidth * activeDpr;
      activeCanvas.height = window.innerHeight * activeDpr;
      
      if (rendererRef.current) {
        rendererRef.current.updateScale(activeDpr);
      }
    };
