          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 font-body text-sm text-gray-400">
              <li className="flex items-start gap-3">
                ...
                <span>Sulaki Chauraha, Prayagraj, UP 211003</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-5 w-5 text-saffron shrink-0" />
                <span>+91 94152 36933</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-5 w-5 text-saffron shrink-0" />
                <span className="break-all">hanumanpushpvarshacommitte@gmail.com</span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 font-body text-sm text-gray-400">
              <li className="flex justify-between border-b border-gray-800 pb-2">
                ...
                <span className="text-saffron-light">04:00 AM</span>
              </li>
              <li className="flex justify-between border-b border-gray-800 pb-2">
                <span>{t("footer.timings.darshan")}</span>
                <span className="text-saffron-light">09:00 AM - 09:00 PM</span>
              </li>
              <li className="flex justify-between border-b border-gray-800 pb-2">
                <span>{t("footer.timings.evening")}</span>
                <span className="text-saffron-light">08:30 PM</span>
              </li>
            </ul>
          </div>
        </div>
